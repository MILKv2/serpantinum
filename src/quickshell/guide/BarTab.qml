            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Layout.alignment: Qt.AlignVCenter
                        spacing: rootObj.s(2)
                        Text { Layout.fillWidth: true; text: I18n.t("guide.bar.workspace_groups.title") || "Workspace group per monitor"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(13); color: ThemeBackend.text }
                        Text { Layout.fillWidth: true; text: I18n.t("guide.bar.workspace_groups.desc") || "Each bar shows its own monitor's block of workspaces (1-N, N+1-2N, ...)"; font.family: ThemeBackend.fontFamily; font.pixelSize: rootObj.s(11); color: ThemeBackend.subtext0 }
                    }
